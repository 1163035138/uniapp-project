  ...
  setup(__props) {
    ...
    const fetchTabsData = () => {
      return common_vendor.__awaiter(this, void 0, void 0, function* () {
        try {
          ...
          common_vendor.index.__f__("error", "at pages/index/components/home.uvue:104", "获取标签数据失败", error);
        }
      });
    };
    const fetchFlowData = () => {
      return common_vendor.__awaiter(this, void 0, void 0, function* () {
        ...
        try {
          ...
          common_vendor.index.__f__("error", "at pages/index/components/home.uvue:131", "获取瀑布流数据失败", error);
          loadStatus.value = "loadmore";
        } finally {
        }
      });
    ...
    return (_ctx = null, _cache = null) => {
      const __returned__ = common_vendor.e(new UTSJSONObject({
        a: common_vendor.o(blurFetchFlowData),
            ...
            a: common_vendor.w((_a, s1 = null, i1 = null) => {
              ...
              return common_vendor.e(common_vendor.unref(tabCurrent) === index ? {
                a: common_vendor.f(leftList, (item1 = null, index1 = null, i2 = null) => {
                  var _a2;
                  return {
                    a: "87e02252-3-" + i0 + "-" + i1 + "-" + i2 + "," + ("87e02252-2-" + i0),
                    b: common_vendor.p({
                      threshold: "0",
                      ["border-radius"]: "10",
                    ...
                    d: "87e02252-4-" + i0 + "-" + i1 + "-" + i2 + "," + ("87e02252-2-" + i0),
                    ...
                    g: "87e02252-5-" + i0 + "-" + i1 + "-" + i2 + "," + ("87e02252-2-" + i0),
            ...
            c: common_vendor.w((_a, s1 = null, i1 = null) => {
              ...
              return common_vendor.e(common_vendor.unref(tabCurrent) === index ? {
                a: common_vendor.f(rightList, (item2 = null, index2 = null, i2 = null) => {
                  var _a2;
                  return {
                    a: "87e02252-6-" + i0 + "-" + i1 + "-" + i2 + "," + ("87e02252-2-" + i0),
                    b: common_vendor.p({
                      threshold: "0",
                      ["border-radius"]: "10",
                    ...
                    d: "87e02252-7-" + i0 + "-" + i1 + "-" + i2 + "," + ("87e02252-2-" + i0),
                    e: common_vendor.p(new UTSJSONObject({
                      src: item2.avatar,
                      width: "30rpx",
                      height: "30rpx",
                    ...
                    g: "87e02252-8-" + i0 + "-" + i1 + "-" + i2 + "," + ("87e02252-2-" + i0),
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-87e02252"]]);
