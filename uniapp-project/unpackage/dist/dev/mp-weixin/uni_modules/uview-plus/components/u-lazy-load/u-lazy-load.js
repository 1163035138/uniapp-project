...
const _sfc_main = common_vendor.defineComponent({
  ...
  created() {
    this.observer = new UTSJSONObject({});
  },
  watch: {
    isShow(nVal = null) {
      if (!this.isEffect)
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    q: Number($data.opacity),
    r: $props.borderRadius + "rpx",
    s: `opacity ${$data.time / 1e3}s ease-in-out`,
    t: common_vendor.n("u-lazy-item-" + $data.elIndex)
  });
}
